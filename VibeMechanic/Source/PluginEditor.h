...
class  VibeMechinicAudioProcessorEditor  :
public juce::AudioProcessorEditor
{
public:
     VibeMechinicAudioProcessorEditor ( VibeMechanicAudioProcessor&);
    ~ VibeMechinicAudioProcessorEditor() override;
...
private:
     ...
     VibeMechanicAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR ( VibeMechinicAudioProcessorEditor)
};
