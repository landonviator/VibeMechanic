...
void  VibeMechanicAudioProcessor::parameterChanged(const juce::String &parameterID, float newValue)
{
    updateParameters();
}

void  VibeMechanicAudioProcessor::updateParameters()
{
    // Distortion
...
//==============================================================================
const juce::String  VibeMechanicAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool  VibeMechanicAudioProcessor::acceptsMidi() const
{
...
bool  VibeMechanicAudioProcessor::producesMidi() const
{
...
bool  VibeMechanicAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double  VibeMechanicAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int  VibeMechanicAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int  VibeMechanicAudioProcessor::getCurrentProgram()
{
    return 0;
}

void  VibeMechanicAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String  VibeMechanicAudioProcessor::getProgramName (int index)
{
    return {};
}

void  VibeMechanicAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void  VibeMechanicAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void  VibeMechanicAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool  VibeMechanicAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void  VibeMechanicAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool  VibeMechanicAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor*  VibeMechanicAudioProcessor::createEditor()
{
    return new  VibeMechinicAudioProcessorEditor (*this);
    //return new juce::GenericAudioProcessorEditor (*this);
}

//==============================================================================
void  VibeMechanicAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
    // Save params
...
void  VibeMechanicAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
    // Recall params
...
{
    return new  VibeMechanicAudioProcessor();
}
